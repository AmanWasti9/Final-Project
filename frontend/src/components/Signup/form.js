        ...
        <div className="flex-row">
          <button className="btn google">
            <svg width="20" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
              ...
              <path style={{ fill: '#F14336' }} d="M419.404,58.936l-82.933,67.896c-23.335-14.586-50.937-23.147-80.471-23.147c-65.351,0-120.99,41.091-142.571,98.781l-82.975-67.896h-0.014C73.748,54.444,158.509,0,256,0C318.115,0,374.2,22.126,419.404,58.936z" />
            </svg>
            Google
          </button>
        </div>
